...
![Version](https://img.shields.io/badge/Version-3.3.10-red.svg)
...
dependencies {
    implementation "dev.lightdream:logger:3.3.10"
    implementation "com.github.L1ghtDream:logger:3.3.10"
}
```
